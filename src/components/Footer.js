      ...
      <footer className={classes.footer}>
        <Container maxWidth="sm">
          <Typography variant="body1">
            Modificado por{" "}
            <Link
              href="https://github.com/MauricioVergaraG"
              target="_blank"
              rel="noopener"
              color="inherit"
            >
          ...
          <Chip
            ...
            avatar={
              <Avatar src={`/assets2/icons/${currAvatar}-logo.png`}></Avatar>
            }
            label="Recibimos Donaciones"
            clickable
          ...
          >
            <DialogTitle>{"Laboratoiro Docker Uniminuto"}</DialogTitle>

            <DialogContent>
              <Hidden xsDown>
                <DialogContentText style={{ textAlign: "center" }}>
                  Hat.sh Laboratoiro Uniminuto, esta app fue modificada para
                ...
                <TabPanel value={tabValue} index={index} key={index}>
                  <div className={classes.qr}>
                    <QRCode
                      ...
                      includeMargin={true}
                      imageSettings={{
                        src: `/assets2/icons/${res.alt}-logo.png`,
                        x: null,
                        y: null,
                        height: 40,
                        width: 40,
